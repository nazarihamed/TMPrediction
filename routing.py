...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def add_flow(self, datapath, priority, match, actions, buffer_id=None):
        ...
        # self.logger.info("#################################")
        # self.logger.info("mod message: %s", mod)
        # self.logger.info("#################################")
    ...
    def _packet_in_handler(self, ev):
        ...
        if eth_pkt.ethertype == ether_types.ETH_TYPE_LLDP: # or eth_pkt.ethertype == 35020:
            ...
            return
            # -------------------
            # avoid broadcast from LLDP (35020 = 0x88CC)
        ...
        #     return None
            ...
            if out_port != ofproto.OFPP_FLOOD:
                match = parser.OFPMatch(in_port=in_port, eth_dst=dst_mac, eth_src=src_mac,ipv4_dst=dst_ip, ipv4_src=src_ip, eth_type=eth_pkt.ethertype)
